...
import org.vuphone.assassins.sql.SqlConstructor;

/**
 * This class is the entry point for the Assassins server. The class spawns an
 * HTTP server and registers the core Assassins servlets.
 * 
 * @author jules
 * 
 */
public class AssassinsServer {
	...
	public static final String ASSASSINS_PATH = "/assassins";
	public static final String ASSASSINS_EVENT_CHANNEL = "/events";
	public static final String ASSASSINS_NOTIFICATIONS_CHANNEL = "/notifications";
	public static final String ASSASSINS_BROWSER_AJAX_CHANNEL = "/map";
	public static final String ASSASSINS_BROWSER_CHANNEL = "/wrecks";
	

	private static final Logger logger_ = Logger
			.getLogger(AssassinsServer.class.getName());
	...
	public static void main(String[] args) throws Exception {
		Logger logger = Logger.getLogger("org.vuphone.assassins"); 
		...
		(new AssassinsServer()).start(port);
	}
	...
	public void start(int port) {
		...
		context.addServlet(new ServletHolder(cometd), ASSASSINS_PATH
				+ ASSASSINS_EVENT_CHANNEL + "/*");
		...
		context.addServlet(new ServletHolder(notificationServlet), ASSASSINS_PATH
				+ ASSASSINS_NOTIFICATIONS_CHANNEL + "/*");
		
		//HttpServlet mapServlet = (HttpServlet)ServerUtils.get().getFactory().getBean(MAP_SERVLET);
		//context.addServlet(new ServletHolder(mapServlet), ASSASSINS_PATH + ASSASSINS_BROWSER_AJAX_CHANNEL + "/*");
		
		//HttpServlet jspServlet = (HttpServlet)ServerUtils.get().getFactory().getBean(JSP_SERVLET);
		//context.addServlet(new ServletHolder(jspServlet), ASSASSINS_PATH + ASSASSINS_BROWSER_CHANNEL + "/*.jsp");
