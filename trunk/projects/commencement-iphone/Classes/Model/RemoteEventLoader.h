...
#define EVENT_REQUEST_URL_STRING @"http://mobileapps.vanderbilt.edu/vandyupon/events"
#define EVENT_SUBMIT_URL_STRING @"http://mobileapps.vanderbilt.edu/vandyupon/events"
