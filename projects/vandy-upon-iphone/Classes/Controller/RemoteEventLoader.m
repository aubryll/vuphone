...
{	// Format the url string
	...
	[urlString appendFormat:@"&lat=%f", 0.0f];
	[urlString appendFormat:@"&lon=%f", 0.0f];
	[urlString appendFormat:@"&lat=%f", 0.0f];
...
//	NSData *responseData = [NSData dataWithContentsOfURL:searchUrl];
	NSData *responseData = [NSData dataWithContentsOfFile:@"/Users/thompsonaaron/PROGRAMMING/Projects/VandyUpon/sampleEventRequestResponse.xml"];
	NSError *err = nil;
