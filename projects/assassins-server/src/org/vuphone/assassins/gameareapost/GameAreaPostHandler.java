...
public class GameAreaPostHandler implements NotificationHandler {

	private static final Logger logger_ = Logger
			.getLogger(GameAreaPostHandler.class.getName());
	
	// XML will instantiate this
	private GameAreaPostParser parser_;
	...
	public Notification handle(Notification n) {
		...
		GameAreaPostNotification report;
		...
		ServerGameArea.getInstance().setGameArea(report.getLatitude(), 
				report.getLongitude(), (float)report.getRadius());
	...
	public GameAreaPostParser getParser() {
		return parser_;
	}

	public void setParser(GameAreaPostParser parser) {
		parser_ = parser;
	}
