/** Updated by Matthew Lavin, 10/18/2011
 */
...
public class StaticRestaurantData {
        ...
        public static final int NUM_RESTAURANTS = 50;
        ...
        private void commonGroundsData() {
                ...
                String description = "Common Grounds, the 24-hour coffee shop in The Commons Center, offers grab-n-go meals, beverages and sundries. Particular emphasis on using biodegradable/compostable products and only serves 100% organic/fair trade coffee.";
        ...
        private void lastDropData() {
                RestaurantHours rh = new RestaurantHours();

                // Last Drop Coffee Shop is closed on Saturday
                Time start = new Time(15, 0);
                ...
                String description = "The Last Drop Coffee Shop serves up coffee, tea, smoothies, frozen yogurt and grab-n-go meal plan options.";

                Restaurant lastDrop = new Restaurant("Last Drop Coffee Shop", rh,
                                false, (int) (36.146545 * 1E6), (int) (-86.803471 * 1E6),
                                "Smoothie", null, description, R.drawable.r_centersmoothie,
                                true, true, false, null,
                                "http://www.vanderbilt.edu/dining/line_coffeeshop.php");
                long id = lastDrop.create();

                if (DEBUG) {
                        DbWrapper.resetRestaurantCache();
                        Log.i("StaticRestaurantData", String.valueOf(lastDrop
                                        .equals(Restaurant.get(id))));
                }
        }
        ...
        private void libraryData() {
                ...
                String description = "Food for Thought Cafe offers an assortment of delicious salads, soups, paninis, sides and desserts located in the Central Library.";
                ...
                if (DEBUG) {
                        DbWrapper.resetRestaurantCache();
                        Log.i("StaticRestaurantData", String.valueOf(library
                                        .equals(Restaurant.get(id))));
                }
        }
        ...
        private void varsitySarrattData() {
                RestaurantHours rh = new RestaurantHours();
                // Restaurant is closed all day on Saturday

                Time start = new Time(20, 0);
        ...
        private void calypsoData() {
    		RestaurantHours rh = new RestaurantHours();

    		Time start = new Time(11, 30);
    		...
    		Restaurant calypso = new Restaurant("Calypso Cafe", rh,
    				...
    				"Island", null, null, R.drawable.r_chipotle, true,
    				false, true, "(615) 321-3878",
    				"http://www.calypsocafe.com/");
    		long id = calypso.create();

    		if (DEBUG) {
    			DbWrapper.resetRestaurantCache();
    			Log.i("StaticRestaurantData", String.valueOf(calypso
    					.equals(Restaurant.get(id))));
    		}
    	}
...
/*	private void cheeseburgerCharleysData() {
    ...
    private void dominosData() {
		...
		Restaurant dominos = new Restaurant("Dominos Pizza", rh,
				false, (int) (36 * 1E6), (int) (-86 * 1E6),
				"Pizza", null, null, R.drawable.r_chipotle, true,
				false, true, "(615) 297-3000",
				"http://www.dominos.com/");
		long id = dominos.create();

		if (DEBUG) {
			DbWrapper.resetRestaurantCache();
			Log.i("StaticRestaurantData", String.valueOf(dominos
					.equals(Restaurant.get(id))));
		}
	}
	
    
    private void irisData() {
		RestaurantHours rh = new RestaurantHours();
		...
		if (DEBUG) {
			DbWrapper.resetRestaurantCache();
			Log.i("StaticRestaurantData", String.valueOf(iris
					.equals(Restaurant.get(id))));
		}
	}
...
/*
    ...
    private void moesData() {
		...
		Restaurant moes = new Restaurant("Moe's Southwest Grill", rh,
				false, (int) (36 * 1E6), (int) (-86 * 1E6),
				"Southwest", null, null, R.drawable.r_chipotle, true,
		...
		if (DEBUG) {
			DbWrapper.resetRestaurantCache();
			Log.i("StaticRestaurantData", String.valueOf(moes
					.equals(Restaurant.get(id))));
		}
	}
    ...
    private void pinkberryData() {
		...
		Restaurant pinkberry = new Restaurant("Pinkberry", rh,
				false, (int) (36 * 1E6), (int) (-86 * 1E6),
				"Frozen Yogurt", null, null, R.drawable.r_chipotle, true,
				false, true, "(615) 679-9789",
				"http://www.pinkberry.com/");
		long id = pinkberry.create();

		if (DEBUG) {
			DbWrapper.resetRestaurantCache();
			Log.i("StaticRestaurantData", String.valueOf(pinkberry
					.equals(Restaurant.get(id))));
		}
	}
    ...
    private void provenceData() {
		RestaurantHours rh = new RestaurantHours();

		Time start = new Time(8, 0);
		Time stop = new Time(18, 0);
		rh.addRange(Calendar.SUNDAY, new Range(start, stop));
		...
		if (DEBUG) {
			DbWrapper.resetRestaurantCache();
			Log.i("StaticRestaurantData", String.valueOf(provence
					.equals(Restaurant.get(id))));
		}
	}
...
/*	private void smoothieKingTwentyFirstData() {
    ...
    private void zumisData() {
		...
		Restaurant zumis = new Restaurant("Zumi Sushi Japanese Kitchen", rh,
				false, (int) (36 * 1E6), (int) (-86 * 1E6),
				"Sushi", null, null, R.drawable.r_chipotle, true,
				false, true, "(615) 383-5770",
				"http://www.zumisushi.com/");
		long id = zumis.create();

		if (DEBUG) {
			DbWrapper.resetRestaurantCache();
			Log.i("StaticRestaurantData", String.valueOf(zumis
					.equals(Restaurant.get(id))));
		}
	}
}
